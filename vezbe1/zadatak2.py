...
def pronadji_osobu(osobe, jmbg):
    return osobe.get(jmbg) #vraca none ako kljuc nije pronadjen; zaobilazi gresku
...
def obrisi_osobu(osobe):
    ...
    osobe.pop(jmbg, None) # sa None kao drugim parametrom, zaobilazi KeyError ako kljuc nije pronadjen
